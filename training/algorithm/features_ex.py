...
class features_exctractor(CTDataset):
    ...
    def give_image(self,idx):
        ...
        ID  =sitk_image.GetMetaData("PatientID")
        return sitk.GetArrayFromImage(sitk_image),age,sex,vox_dim,ID
    ...
    def componenti_connesse(self,idx):
        img = sitk.Cast(self.read_image(idx),sitk.sitkInt8)
